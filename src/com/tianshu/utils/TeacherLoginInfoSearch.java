...
public class TeacherLoginInfoSearch {
    public Teacher teacherlogin(String Username, String Password) {
        ...
        try {
            ...
            String sql = "SELECT * from Teacher_table where Teacher_name=? and Teacher_password=?";
    ...
    public static void main(String[] args) {
        ...
        Teacher teacher_cindy=teacherLoginInfoSearch.teacherlogin("Cindy","5PWv9r");
        System.out.println(teacher_cindy);
