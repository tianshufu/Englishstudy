...
@WebServlet("/studentsearchbooks")
public class StudentSearchBooksServlet extends HttpServlet {
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        //Coursevideo coursevideo=new Coursevideo();
        BooksInfo booksInfo=new BooksInfo();
        List<Book> booklist=booksInfo.Searchallbooksinfo();
        req.setAttribute("bookinfo",booklist);
        req.getRequestDispatcher("StudentSearchBookList.jsp").forward(req,resp);
