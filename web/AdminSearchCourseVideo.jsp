...
<div class="wrapper d-flex align-items-stretch">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components mb-5">
            ...
            <li>
                <a href="adminsearchstudentinfo"><span class="fa fa-fa-address-book mr-3"></span> Student Info</a>
            </li>
    ...
    <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <div class="container-fluid">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                <c:forEach items="${requestScope.videoinfo}"   var="coursevideo" >
                    <tr>
                        <th scope="row">${coursevideo.student_id}</th>
                        <td>${coursevideo.teacher_id}</td>
                        <td>${coursevideo.date}</td>
                        <td>${coursevideo.time_slot}</td>
                        <td><a href=${coursevideo.video_url}>Click to view</a></td>
