            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        ...
                        <%--card list: student comement lists--%>
                        <c:forEach items="${requestScope.studentcoursecommentlist}" var="studentcourseinfo">
                            <div class="card " >
                                <div class="card-header">

                                    ${studentcourseinfo.date}
                                    ${studentcourseinfo.timeslot}
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title">${studentcourseinfo.teachername}</h5>
                                    <p class="card-text">Pronounciation: ${studentcourseinfo.pronounciation}</p>
                                    <p class="card-text">Gramma: ${studentcourseinfo.gramma}</p>
                                    <p class="card-text">Comment: ${studentcourseinfo.comment}</p>
                                    <a href="StudentClassComment.jsp?teacherid=${studentcourseinfo.teacherid}&teachername=${studentcourseinfo.teachername}&date=${studentcourseinfo.date}&timeslot=${studentcourseinfo.timeslot}" class="btn btn-primary">Rate Teacher</a>
                                </div>
                            </div>
                       </c:forEach>
