...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5 pt-5">
        <div class="container-fluid">
            ...
            <table class="table table-striped ">
                ...
                <c:forEach items="${requestScope.bookinfo}"   var="book" >
                    ...
                    <tr>
                        ...
                        <td>
                            <form type="post" action="${pageContext.request.contextPath}/admindeletebook">
                                <input type="hidden" name="bookurl" value=${book.bookurl}>
                                <input type="hidden" name="bookid" value=${book.bookid}>
                                <input type="submit" class="btn btn-primary" value="Delete" onclick="return confirm('Are you sure to Delete this book?')" />
                            </form>
            ...
            <li class="active">
                <a href="adminuploadbooktoken"><span class="fa fa-upload mr-3"></span> Add Book</a>
            </li>
        </div>
    </div>
