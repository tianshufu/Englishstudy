...
<link rel="stylesheet" type="text/css" href="css/ratebar.css">
...
<%
    ...
    String studenname=(String)session.getAttribute("username");
    String teacherid=request.getParameter("teacherid");
    String teachername=request.getParameter("teachername");
    String coursedate = request.getParameter("date");     // 接收id
    String courseslot = request.getParameter("timeslot"); // 接收姓名
...
<div class="container-fluid" >
        ...
        <div class="col-md-6 offset-3 order-md-1">
            <div class="py-5 text-center ">
                ...
                <h2>Comment form</h2>
                <p class="lead">We appricate every piece of your commment.</p>
            </div>


            <form type="post" action="${pageContext.request.contextPath}/studentclasscomment" class="-align-center">
                ...
                <fieldset disabled>
                    ...
                    <div class="form-group">
                        <div>
                            ...
                            <input type="text" id="disabledTextInput0" class="form-control" placeholder="Disabled input" value=<%=studenname%> >
                ...
                <div class="feedback form-group col-md-12" >
                    <p>Score:</p>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="studentcomment"></textarea>
                </div>
